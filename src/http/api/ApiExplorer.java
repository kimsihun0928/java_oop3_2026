...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=85193852f1312276a3fe0700f0dd0c9e178fa13e417b6d29de8a223f986e30a4"); /*Service Key*/
        ...
        Gson gson = new Gson();
        AirQuality airQuality = gson.fromJson(sb.toString(), AirQuality.class);

        System.out.println(airQuality.getResponse().getBody().getTotalCount());
        System.out.println(airQuality.getResponse().getBody().getItems().get(0).getSn());
    }
